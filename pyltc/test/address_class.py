...
# from pybynd.transaction import *
from pybynd import OPCODE
...
class AddressClassTests(unittest.TestCase):
    ...
    def test_is_WIF_valid(self):
        # mainnet
        self.assertEqual(pybynd.PrivateKey("7fbda89e59e07db5897cabfde8eb8036d4bebdfddfeac97319e74c74c02799f2",
                                            compressed=True, testnet=False).wif,
                         'T7LHhPHG4mno7XPvBXajDrA5v2nLVSw16sTErD9y6Yki3bGTuHgf')
        self.assertEqual(pybynd.PrivateKey("aaf19a8a8eacca26b2ec3678e47ee22a04fc1efac61bcd2a41af332be63bab8b",
                                            compressed=False, testnet=False).wif,
                         '6vRJaVegzBxTXdgGEimmmSsEv1CLdAgfpaHsZbXUxkPfm9H8U7X')
        # # testnet
        self.assertEqual(pybynd.PrivateKey("fef231a9299de5b2d3ea012cd2471bdc80d38e489f5f4a7803ac3279a7d727a9",
                                            compressed=True, testnet=True).wif,
                         'cW8HPuCThQ4EsLEU8S6Gborp7NfwXDc2uh2Aua83kmhjqN8GzEVk')
        self.assertEqual(pybynd.PrivateKey("fc1528167b31735464059aef58cf71b501eaa146bae7e47f406c61f7ac28555c",
                                            compressed=False, testnet=True).wif,
                         '93VwGxfztHBcUefSWA3JMzKsr6Jg4atmZdKvi1MXTgB9HLypXry')

        self.assertEqual(pybynd.PrivateKey("cW8HPuCThQ4EsLEU8S6Gborp7NfwXDc2uh2Aua83kmhjqN8GzEVk",
                                            compressed=False, testnet=True).wif,
                         'cW8HPuCThQ4EsLEU8S6Gborp7NfwXDc2uh2Aua83kmhjqN8GzEVk')

        p = pybynd.PrivateKey("7b56e2b7bd189f4491d43a1d209e6268046df1741f61b6397349d7aa54978e76")
        pub = pybynd.PublicKey(p)
        a = pybynd.Address(p)
        # self.assertEqual(a.address, 'bc1qxsms4rt5axt9674du2az7vq3pvephu3k5jyky8')
        # a = pybynd.Address(p, address_type = "P2PKH")
        # self.assertEqual(a.address, '15m65JmFohJiioQbzMWhqFeCS3ZL1KVaNh')
        # a = pybynd.Address(p, address_type = "PUBKEY")
        # self.assertEqual(a.address, '15m65JmFohJiioQbzMWhqFeCS3ZL1KVaNh')
        a = pybynd.Address(p, address_type = "P2SH_P2WPKH", legacy=True)
        ...
        self.assertEqual(pybynd.PublicKey("7b56e2b7bd189f4491d43a1d209e6268046df1741f61b6397349d7aa54978e76",
        ...
        # self.assertEqual(pybynd.PublicKey("L1MU1jUjUwZ6Fd1L2HDZ8qH4oSWxct5boCQ4C87YvoSZbTW41hg4",
        #                                    compressed=False).hex, cpk)
        # # public key compressed from  PrivateKey instance (flags have no effect)
        # p = pybynd.PrivateKey("L1MU1jUjUwZ6Fd1L2HDZ8qH4oSWxct5boCQ4C87YvoSZbTW41hg4")
        # self.assertEqual(pybynd.PublicKey(p, compressed=False).hex, cpk)
        #
        # # public key compressed from  public
        # self.assertEqual(pybynd.PublicKey(cpk, compressed=False).hex, cpk)
        #
        # # public key compressed from  public
        # self.assertEqual(pybynd.PublicKey(unhexlify(cpk), compressed=False).hex, cpk)
        #
        # # compressed public key
        # # private key hex string to compressed pub key
        # p = pybynd.PrivateKey("7b56e2b7bd189f4491d43a1d209e6268046df1741f61b6397349d7aa54978e76", compressed=False)
        # pub = pybynd.PublicKey(p)
        # a = pybynd.Address(p, address_type="P2PKH")
        ...
        #
        # from pubkey
        p = pybynd.PublicKey('02a8fb85e98c99b79150df12fde488639d8445c57babef83d53c66c1e5c818eeb4')
        a = pybynd.Address(p)
        # self.assertEqual(a.address, 'bc1qxsms4rt5axt9674du2az7vq3pvephu3k5jyky8')
        # a = pybynd.Address(p, address_type="P2PKH")
        # self.assertEqual(a.address, '15m65JmFohJiioQbzMWhqFeCS3ZL1KVaNh')
        ...
        p = pybynd.PublicKey('04a8fb85e98c99b79150df12fde488639d8445c57babef83d53c66c1e5c818eeb43bbd96a641808'
        ...
        a = pybynd.ScriptAddress(redeem, witness_version=None, legacy=True)
